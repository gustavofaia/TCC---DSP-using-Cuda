...
#define N_interpol 8
#define N_decimacao 8
#define N_aliasing 8
#define N_filtragens_interpol 1
#define N_filtragens_decimacao 1
#define N_estagios 100
...
int main()
{
    ...
    file_in = sf_open ("sweep_10s.wav", SFM_READ, &sfinfo_in); //Determina o arquivo de entrada
    sfinfo_out=sfinfo_in;
    file_out = sf_open ("sweep_100_cpu.wav", SFM_WRITE, &sfinfo_out); //Determina o arquivo de saída
    ...
    double a_interpol[N_interpol] = {
        #include "a_interpol_26.txt"
    };
    double b_interpol[N_interpol+1] = {
        #include "b_interpol_26.txt"
    };
    double a_decimacao[N_decimacao] = {
        #include "a_decimacao_26.txt"
    };
    double b_decimacao[N_decimacao+1] = {
        #include "b_decimacao_26.txt"
    };
    double a_aliasing[N_aliasing] = {
        #include "a_aliasing_26.txt"
    };
    double b_aliasing[N_aliasing+1] = {
        #include "b_aliasing_26.txt"
    };
